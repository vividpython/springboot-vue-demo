...
/**
 * @description: 这个过滤器是要注册到shiro配置里面去的，用来辅助shiro进行过滤处理。
 * @param :
 * @return
 * @author: Zheng
 * @date: 2023/6/2 9:35
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    private void responseError(ServletResponse response, String message) {
        ...
        try {
            ...
            System.out.println("responseError" + httpServletResponse.getStatus());
            httpServletResponse.setStatus(HttpServletResponse.SC_UNAUTHORIZED); // 返回401状态码
